package modules
{
	...
	{				
		...
		public function switchSelectedMenuButton():void
		{			
			// Get menu item index if there is menu item that refers
			// to the current page.
			if (!limitedMode)
				setMenuItemSelected(getMenuItemIndexByPageID(
					moto.currentPage));
		}
