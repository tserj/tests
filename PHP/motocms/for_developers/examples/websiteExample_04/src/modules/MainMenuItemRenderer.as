package modules
{
	...
	public class MainMenuItemRenderer extends AbstractMenuItemRenderer
	{
		...
		override public function updateRenderer(data:Object):void
		{
			...
			var labelProperty:PropertyVO = menuItemVO.getPropertyByID(1);
			for (var i:uint = 1; i < 4; i++)
			{
				...
				MotoUtils.setHTMLTextFromPropertyVO(_label,  labelProperty);
		...
		override public function changeState(label:String):void
		{
